<?php  //[STAMP] a3ffd07f3e4522610f86af17bed2f342
...
trait HttpTesterActions
{
     ...
     * @see \Helper\Http::grabFullCurrentUrl()
     */
    public function grabFullCurrentUrl() {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('grabFullCurrentUrl', func_get_args()));
    }
     ...
     * @return string
     * @throws \Codeception\Exception\ModuleException
     * @see \Helper\Http::retrieveFullUri()
     */
    public function retrieveFullUri() {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('retrieveFullUri', func_get_args()));
    }
     ...
     * @see \Helper\Http::seeCurrentFullUrlMatches()
     */
    public function canSeeCurrentFullUrlMatches($fullUrl) {
        return $this->getScenario()->runStep(new \Codeception\Step\ConditionalAssertion('seeCurrentFullUrlMatches', func_get_args()));
    }
    /**
     * [!] Method is generated. Documentation taken from corresponding module.
     *
     ...
     * @see \Helper\Http::seeCurrentFullUrlMatches()
     */
    public function seeCurrentFullUrlMatches($fullUrl) {
        return $this->getScenario()->runStep(new \Codeception\Step\Assertion('seeCurrentFullUrlMatches', func_get_args()));
    }
