 ...
 * Usage:
 *
 * * `codecept gherkin:snippets api` - snippets from all feature of api tests
 * * `codecept gherkin:snippets api/feature/users` - snippets from `feature/users` dir of api tests
 * * `codecept gherkin:snippets api user_account.feature` - snippets from a single feature file
 * * `codecept gherkin:snippets api/feature/users/user_accout.feature` - snippets from feature file in a dir
 */
