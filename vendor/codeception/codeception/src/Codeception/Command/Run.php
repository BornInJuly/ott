 ...
 * * `codecept run api MyCept`: same as above
 * * `codecept run api MyCest:myTestInIt`: run one test from a Cest
 * * `codecept run api checkout.feature`: run feature-file
 * * `codecept run api -g slow`: run tests from *slow* group
