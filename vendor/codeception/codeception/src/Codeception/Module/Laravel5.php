 ...
 * It should **not** be used for api tests.
 * See the Api tests section below for more details.
 *
 * ## Demo project
 ...
 * ## Api tests
 *
 * You should not use this module for api tests.
 * If you want to use Eloquent within your api tests (paired with WebDriver) enable only
