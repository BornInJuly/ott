    ...
    RequiresPackage
{
     ...
     * ```
     *
     * to make this work load `\Helper\Api` before `WebDriver` in `acceptance.suite.yml`:
     *
     * ```yaml
     * modules:
     *     enabled:
     ...
     * This is how it can be done via `_capabilities` method from `Helper\Api`:
     *
     * ```php
     * <?php // inside Helper\Api
     * public function _before(TestInterface $test)
     * {
     ...
     * }
     * ```
     * In this case, please ensure that `\Helper\Api` is loaded before WebDriver so new capabilities could be applied.
     *
     * @api
