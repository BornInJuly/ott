 ...
 * ```
 *
 * You can use this module by setting params in your `http.suite.yml`:
 *
 * ```yaml
 * actor: HttpTester
 * modules:
 ...
 * Do not forget that after adding module in your http.suite.yml you must run codeception "build" command.
 *
 * ### Public Properties
 *
 ...
 *
 * * `init`: only initializes module and not provides any actions from it. Can be used for unit/api tests to avoid conflicts.
 *
 * ### Api Testing Example:
 *
 * In `api.suite.yml`:
