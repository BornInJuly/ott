 ...
 * * `transaction` - (default: true) wrap all database connection inside a transaction and roll it back after the test. Should be disabled for api testing..
 ...
 *
 * * `init` - use module only for initialization (for api tests).
